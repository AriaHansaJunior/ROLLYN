...
interface WeightDetectionEngineProps {
   ...
   */
  onWeightConfirmed: (weight: number, weightDisplay: string, source: 'ocr' | 'manual') => void;
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, maxWidth: 900 }}
      ...
      <div className="card" style={{ padding: 16 }}>
        ...
        {/* ── IDLE state ── */}
        {(engineState === 'permission_modal' || engineState === 'requesting' ||
          engineState === 'camera_active' || engineState === 'camera_denied') && (
        ...
        {engineState === 'success' && ocrResult && (
          <div>
            ...
            <div style={{
              ...
              padding: '9px 13px',
              background: '#f2f9f2', border: '1px solid #d4edda',
              borderRadius: 6, marginBottom: 14,
            }}>
              <CheckCircle size={15} style={{ color: '#5CB85C', flexShrink: 0 }} />
              <span style={{ fontSize: 12, fontWeight: 600, color: '#3C763D' }}>
                Recognition Successful — {ocrResult.confidence.toFixed(1)}% confidence
              </span>
            </div>
            ...
            <div style={{ textAlign: 'center', padding: '20px 0 16px' }}>
              ...
              <div style={{
                fontSize: 56, fontWeight: 800, color: '#286090',
        ...
        {engineState === 'error' && ocrError && (
          <div>
            ...
            <p style={{ fontSize: 12, color: '#888', marginBottom: 14 }}>
              You can click <strong>Take Photo</strong> again to retry, or enter the weight manually below.
            </p>
